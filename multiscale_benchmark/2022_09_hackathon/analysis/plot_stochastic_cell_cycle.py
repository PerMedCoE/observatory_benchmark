...
def create_parser():
    ...
    parser.add_argument("--pc-csv", action="store", dest = "pc_csv",help="Path to the PhysiCell cell volumes for fixed cell cycle",
                        default="../Physicell/output/stochastic_cell_cycle/cells_volumes.csv")
...
def plot(pc_df,ch_df,ts_df):
    ...
    v1=[1,1,1,1,1,1,1.19558,1.38407,1.54093,1.67035,1.7722,1.84849,1.90281,1.93989,1.96517,1.98518,1.51771,1.00349,1.00349,1.00349,1.00349,1.00349,1.00349,1.00349,1.29607,1.46583,1.60913,1.72464,1.81335,1.87812,1.92318,1.95453,1.97589,1.99457,1.00198,1.00198,1.00198,1.00198,1.00198,1.00198,1.00198,1.21615,1.39614,1.5511,1.67852,1.77846,1.85305,1.90751,1.94306,1.96705]
    t1=[1.03111,2.02667,3.02222,4.01778,5.01333,6.00889,7.00444,8.03556,9.03111,10.0267,11.0222,12.0178,13.0133,14.0089,15.0044,16.0356,17.0667,18.0622,19.0578,20.0533,21.0489,22.0444,23.04,24.0356,25.0311,26.0267,27.0222,28.0178,29.0133,30.0089,31.0044,32.0356,33.0311,34.0267,35.0222,36.0178,37.0133,38.0089,39.0044,40.0356,41.0311,42.0267,43.0222,44.0178,45.0133,46.0089,47.0044,48.0356,49.0311,50.0089]
    plt.plot(t1,[100*x for x in v1], color=colors[2],label='TiSim' ,linewidth=2)

    v2=[1.51771,1.00376,1.00376,1.00376,1.00376,1.00376,1.00376,1.00376,1.44453,1.60521,1.73207,1.8265,1.8926,1.93635,1.96495,1.98698,1.24293,1.00408,1.00408,1.00408,1.00408,1.00408,1.00408,1.00408,1.46333,1.62042,1.74369,1.83484,1.89823,1.94,1.96744,1.98917,1.06032,1.00086]
    t2=[17.0667,18.0622,19.0578,20.0533,21.0489,22.0444,23.04,24.0356,25.0311,26.0267,27.0222,28.0178,29.0133,30.0089,31.0044,32.0356,33.0311,34.0267,35.0222,36.0178,37.0133,38.0089,39.0044,40.0356,41.0311,42.0267,43.0222,44.0178,45.0133,46.0089,47.0044,48.0356,49.0311,50.0089]

    plt.plot(t2,[100*x for x in v2], color=colors[4],linewidth=2)
    v3=[1.24293,1.00374,1.00374,1.00374,1.00374,1.00374,1.00374,1.00374,1.46858,1.62392,1.74579,1.83595,1.89871,1.94014,1.96741,1.98903,1.06018,1]
    t3=[33.0311,34.0267,35.0222,36.0178,37.0133,38.0089,39.0044,40.0356,41.0311,42.0267,43.0222,44.0178,45.0133,46.0089,47.0044,48.0356,49.0311,50.0089]
    plt.plot(t3,[100*x for x in v3], color=colors[6],linewidth=2)

    v4=[1.00158,1.00158,1.00158,1.00158,1.00158,1.00158,1.00158,1.12492,1.3023,1.4602,1.59529,1.70633,1.79389,1.86201,1.90923,1.9417]
    t4=[35.0222,36.0178,37.0133,38.0089,39.0044,40.0356,41.0311,42.0267,43.0222,44.0178,45.0133,46.0089,47.0044,48.0356,49.0311,50.0089]
