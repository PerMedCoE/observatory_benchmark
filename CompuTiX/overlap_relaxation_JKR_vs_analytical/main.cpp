...
//!
//! \subsubsection overlap_relaxation_problem_statement_jkr JKR Model
...
//! \f[
//! \vec{F}_\text{ext_JKR} = \vec{F}_\text{Hertz} + \vec{F}_\text{JKR} = - \frac{4}{3}E^* \frac{a^3}{R} \hat{n} + \sqrt{8 \pi \gamma^* E^* a^3}\hat{n},
//! \f]
...
int main( int argc, char** argv )
{
    ...
    // - contact model DoFs: interfacial tension (tension), tangential friction coefficient (gamma_tangential), normal friction coefficient (gamma_normal), mass tensor (M), relative tolerance (relative_tolerance), contact radius (r_contact), spheres' radius (r)
    ...
    constexpr Types::Scalar t_end = 10. * 60.; // [ s ]
    //Time-step size
