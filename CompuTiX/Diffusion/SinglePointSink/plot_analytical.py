...
def main() -> None:
    ...
    parser.add_argument("--rate", type=float, default=1.6e-16, help="Uptake rate [mol/min].")
    parser.add_argument("-T", "--tend", type=float, default=0.5, help="End time [min].")
    ...
    if(not args.without_average):
        ...
        print( f'concentration whole box stationary [µM]: {1e3 * c_expected_domain[-1]}' )
