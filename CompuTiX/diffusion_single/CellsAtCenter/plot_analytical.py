...
def main() -> None:
    ...
    parser.add_argument("--rate", type=float, default=-1.6e-16, help="Per-cell source/sink strength [mol/min]. Use a negative value for uptake and a positive value for secretion.")
