...
//
// -----------------------------------------------------------------------------
#ifndef UNIT_TEST_MECHANICS_TWO_CELLS_RELAXATION_H_
#define UNIT_TEST_MECHANICS_TWO_CELLS_RELAXATION_H_
...
inline int Simulate(int argc, const char** argv) {
  ...
  auto* cell1 = new Moving_cell({-4.5, 0.0, 0.0});  // Cells' centers are at a distance of 9um (i.e. 90% of diameter)
  auto* cell2 = new Moving_cell({4.5, 0.0, 0.0});
  ...
  // cell2->SetSpeed({-1.0, 0.0, 0.0});  // Movement along x-axis, negative directions 1um/0.1min
